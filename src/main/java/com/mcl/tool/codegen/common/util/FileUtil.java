...
public final class FileUtil {
    ...
    private static String readFileAsOneLine(BufferedReader bufferedReader){
        try{
            StringBuilder sb = new StringBuilder();
            String line = null;
     ...
     * @return
     */
    public static String loadClassPathFile(String path){
        InputStream stream = FileUtil.class.getResourceAsStream(path);
        BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(stream));
        return readFileAsOneLine(bufferedReader);
    }
}
